...
@section('title')
    Active Vendors| Above Ecommerce
@endsection
@section('need-css')
...
@section('main')
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Active Vendors List</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="d-flex justify-content-between">
            <h6 class="mb-0 text-uppercase ">Active Vendor List</h6>
                            ...
                            <div class="col-sm-12">
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('vendor.status.change',$item->id) }}" id="delete" class="btn {{ $item->status=='active'?'btn-danger':'btn-success' }}">Make Inactive</a>
                                    </td>
                                </tr>
                                @endforeach
