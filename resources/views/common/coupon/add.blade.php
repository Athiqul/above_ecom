        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{ route('coupon.list') }}"><i class="bx bx-Coupon"></i></a>
                    </li>
        ...
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('coupon.create') }}" method="post" id="loginForm" >
                                @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9 text-secondary form-group ">
                                    <input type="text" value="{{old('coupon_code') }}" class="form-control @error('coupon_code')
                                        is-invalid
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9 text-secondary form-group ">
                                    <input type="text" placeholder="Percentage/Amount" value="{{old('discount_amount') }}" class="form-control @error('discount_amount')
                                        is-invalid
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9 text-secondary form-group ">
                                    <input type="text" placeholder="Minimum Amount To purchase" value="{{old('min_purchase_amount') }}" class="form-control @error('min_purchase_amount')
                                        is-invalid
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9 text-secondary form-group ">
                                    <input type="text" placeholder="Number of times code will be allow to purchase" value="{{old('limit') }}" class="form-control @error('limit')
                                        is-invalid
                                    @enderror" name="limit">
                                    @error('limit')
                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9 text-secondary form-group ">
                                    <input type="date" onchange="changeDate(event)" name="start_date" min="{{ date('Y-m-d') }}" class="form-control" required>
                                    @error('start_date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9 text-secondary form-group ">
                                    <input type="date" id="last_date" name="last_date" min="{{ date('Y-m-d') }}" class="form-control" required>
                                    @error('last_date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
