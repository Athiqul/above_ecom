        ...
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('banner.create') }}" method="post" id="loginForm" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary form-group">
                                    <input type="text" value="{{ old('url') }}" class="form-control @error('url')
                                        {{ 'is-invalid' }}
                                    @enderror" name="url" >
                                    @error('url')
                                    <span class="text-danger">{{ $message }}</span>
