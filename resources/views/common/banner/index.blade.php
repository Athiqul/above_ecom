                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>{{ $item->url }}</td>
                                    <td>
                                        <img src="{{$item->image==null? asset('uploads/no_image.jpg'):asset('uploads/banners/'.$item->image) }}" style="height: 50px;width:70px;" alt="{{ $item->title }}">
                                    </td>
