...
@section('title')
    Add Division| Above IT Ecommerce
@endsection
        ...
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('division.create') }}" method="post" id="loginForm">
                                @csrf
			...
			$('#loginForm').validate({
				...
				messages: {
					Divisions_name: {
                        ...
                        minlength:'Too short Divisions Name',
                        maxlength:'Too long Divisions Name',
